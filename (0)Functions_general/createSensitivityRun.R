createSensitivityRun<-function(thisRun,runLength="",thisPath,editVar,version="",editGroups, runPrmFile="CRAM_base_run_short",changes,proportionalChange,nextLine,isVector=FALSE,changeVectorIndex=NULL,groupsFileName,biolFileName,varMax,ICfile="CRAM_input.nc", forceFile="CRAM_force"){
