...
this_run<-"TBGB"
this_out<-"SG1"; runFolder<-"TBGB_JP2";


this_path<-paste(DIR$'Base',this_run,"\\",runFolder,"\\",sep="")
outPath<-paste(this_path,"output",this_out,"\\",sep="")
plotPath<-paste(this_path,"..\\Figures\\testing\\",this_run,this_out,"",sep="")
...
thisBiolFile<-paste(this_path,"\\TBGB_biol.prm",sep="")
...
# thisKUP<-0.4  # overwrite to test alt value
