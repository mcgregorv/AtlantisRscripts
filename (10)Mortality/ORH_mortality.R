...
burnin<-45 # starts plots at 1980 (115)
## read in SSB arra
...
firstPlotYear<-min(c(thisCPUE$year, thisSA$year, 1910))
altFirstPlotYear<-1910;
...
par(new=TRUE, las=1)
plot(plotYCS, type="n", lwd=2, col="red", yaxt="n",  xlab="", ylab="", lty=4, xaxt="n", cex.axis=thisCex, cex.lab=thisCex)
