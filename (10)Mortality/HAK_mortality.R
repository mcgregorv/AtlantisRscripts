...
this_run<-"base"
this_out<-paste("FISHmort",sep="") ## this is just like FISH except the mortality file has just non-predation mortality in the M1 entries
...
otherMort<-thisSpecMort[,grep("M1", colnames(thisSpecMort))]
